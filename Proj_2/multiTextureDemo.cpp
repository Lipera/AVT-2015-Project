...
void renderScene(void) {
	...
	objId=0;
	t0->draw(mesh, shader, pvm_uniformId, vm_uniformId, normal_uniformId, texMode_uniformId);
	objId=1;
	t1->draw(mesh, shader, pvm_uniformId, vm_uniformId, normal_uniformId, texMode_uniformId);
