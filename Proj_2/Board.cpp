...
//desenha mesa
void Board::create(struct MyMesh* mesh, int *objId){
...
void Board::draw(struct MyMesh* mesh, VSShaderLib& shader, GLint& pvm_uniformId, GLint& vm_uniformId, GLint& normal_uniformId, GLint& texMode_uniformId, int *objId){
	*objId=1;
	GLint loc;
	// send the material
